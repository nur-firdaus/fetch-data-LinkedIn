        ...
        <div class="row">
            <div class="col-md-6 offset-md-3" style="margin:auto; background: white; padding: 20px; box-shadow: 10px 10px 5px #888;">            
                <div class="panel-heading">
                    ...
                    <p style="font-style: italic;">Share Image Post</p>
                </div>
                <hr>
                <div class="panel-body">
                    ...
                    <hr>
                    <h5>Share Image Post</h5><br>
                    <form action="/shareimage.php" enctype="multipart/form-data" method="post">
                        <input type="hidden" name="profile" value="<?php echo $profile->id; ?>">
                        <textarea placeholder="What's on your mind?" name="content" required="required" id="" cols="30" rows="5" class="form-control"></textarea> <br>
